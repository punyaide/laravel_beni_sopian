        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-8 col-lg-6">
                <div class="text-center mb-5">
                    ...
                    <p class="lead text-white">Enter patient information below</p>
                </div>
                    ...
                    <div class="card-body p-5">
                        ...
                        <form method="POST" action="{{ route('pasien.store') }}">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="nama" class="form-control form-control-lg" placeholder="Enter patient name" required>
                            </div>
